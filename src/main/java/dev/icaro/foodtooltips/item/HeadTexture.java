...
public final class HeadTexture {
    ...
    /** "Miner Helmet" (minecraft-heads.com ID 26723) - shown only on a real Miner's Helmet item (dropped by a Miner or given by /rpgitems), never on the mob's own worn instance, which keeps {@link #ZOMBIE_MINER}/{@link #SKELETON_MINER} - see {@code MinerVariantService#retextureDroppedHelmet}. */
    ...
    public static final Set<String> ALL = Set.of(PLANET, TRASH_CAN, ARROW_RIGHT, ARROW_LEFT, BACK, CLOSE, QUIVER, SUPER_MUSHROOM, ZOMBIE_MINER, SKELETON_MINER, MINER_HELMET_DROP);
