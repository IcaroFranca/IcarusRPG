...
public final class PotionCatalog {
    ...
    private static final List<PotionEntry> ENTRIES = List.of(
            ...
            new PotionEntry("weakness", Material.FERMENTED_SPIDER_EYE, "Fraqueza", "Weakness",
                    List.of("Poção Estranha + Olho de Aranha Fermentado → Fraqueza",
                            "Pó de Redstone → duração estendida", "Sem nível II."),
                    List.of("Awkward Potion + Fermented Spider Eye → Weakness",
                            "Redstone Dust → extended duration", "No level II."),
            ...
            new PotionEntry("adrenaline", Material.SUGAR, "Adrenalina", "Adrenaline",
                    List.of("Poção Estranha + Açúcar → Poção de Adrenalina (Absorção II + Velocidade II)",
                            "Receita exclusiva desta collection (Cocoa Beans M2) - não é uma poção vanilla."),
                    List.of("Awkward Potion + Sugar → Adrenaline Potion (Absorption II + Speed II)",
            ...
            new PotionEntry("archery", Material.ARROW, "Arquearia", "Archery",
                    List.of("Poção Estranha + Flecha → Poção de Arquearia (+12,5% dano de arco/flecha)",
                            "Receita exclusiva desta collection (Feather M6) - não é uma poção vanilla."),
                    List.of("Awkward Potion + Arrow → Archery Potion (+12.5% bow/arrow damage)",
            ...
            new PotionEntry("mana", Material.LAPIS_LAZULI, "Mana", "Mana",
                    List.of("Poção Estranha + Lápis-Lazúli → Poção de Mana (+1 regen. de mana/s)",
                            "Receita exclusiva desta collection (Raw Mutton M2) - não é uma poção vanilla."),
                    List.of("Awkward Potion + Lapis Lazuli → Mana Potion (+1 mana regen/s)",
